<template>
        ...
        <header class="header">
            ...
            <div class="navbar">
                ...
                <div class="navbar-right-container" style="display: flex;">
                    <div class="navbar-menu-container">
                        ...
                        <a href="javascript:void(0)" class="navbar-link" @click="registModelFlag=true">Regist</a>
                    ...
                    <div class="md-content">
                        ...
                        <ul>
                            <li class="regi_form_input">
                                ...
                                <input type="text" v-model="userName"  tabindex="1" name="loginname" placeholder="User Name" data-type="loginname" class="regi_login_input regi_login_input_left">
                            </li>
                            <li class="regi_form_input noMargin">
                                <i class="icon IconPwd"></i>
                                <input type="password" v-model="userPwd" tabindex="2" name="password" placeholder="Password" class="regi_login_input regi_login_input_left login-input-no input_text" @keyup.enter="login">
                            </li>
                        </ul>
                    </div>
            ...
            <div class="md-modal modal-msg md-modal-transition " v-bind:class="{'md-show':registModelFlag}">
                <div class="md-modal-inner">
                    <div class="md-top">
                        <div class="md-title">Regist</div>
                        <button class="md-close" @click="registModelFlag=false">Close</button>
                    </div>
                    <div class="md-content">
                        <div class="confirm-tips">
                            <!--<div class="error-wrap">-->
                                <!--<span class="error error-show" v-show="regErrorTip">用户名或者密码不能为空</span>-->
                            <!--</div>-->
                            <ul>
                                <li class="regi_form_input">
                                    <i class="icon IconPeople"></i>
                                    <input type="text" v-model="regUserName"  tabindex="1" name="regUserName" placeholder="User Name" data-type="regUserName" class="regi_login_input regi_login_input_left">
                                </li>
                                <li class="regi_form_input noMargin">
                                    <i class="icon IconPwd"></i>
                                    <input type="password" v-model="regUserPwd" tabindex="2" name="regUserPwd" placeholder="Password" class="regi_login_input regi_login_input_left login-input-no input_text" @keyup.enter="regist">
                                </li>
                            </ul>
                        </div>
                        <div class="login-wrap"><a href="javascript:;" class="btn-login" @click="regist">注册</a></div>
                    </div>
                </div>
            </div>
            <div class="md-overlay" v-if="registModelFlag" @click="registModelFlag=false"></div>
