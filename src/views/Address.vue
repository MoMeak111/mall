<template>
    <div>
                    ...
                    <div class="addr-list-wrap">
                        <div class="addr-list">
                            <ul>
                                ...
                                <li class="addr-new" @click="addModelFlag=true">
        ...
        <div class="md-modal modal-msg md-modal-transition " v-bind:class="{'md-show':addModelFlag}">
            <div class="md-modal-inner">
                <div class="md-top">
                    <div class="md-title">Add Address</div>
                    <button class="md-close" @click="addModelFlag=false">Close</button>
                </div>
                <div class="md-content">
                    <div class="confirm-tips">
                        <div class="error-wrap">
                            <span class="error error-show" v-show="errorTip">请全部填写详细</span>
                        </div>
                        <ul>
                            ...
                            <li class="regi_form_input noMargin">
                                ...
                                <input type="text" v-model="streetName" tabindex="2" name="streetName" placeholder="streetName" class="regi_login_input regi_login_input_left login-input-no input_text" @keyup.enter="addAddress">
                            </li>
                            <li class="regi_form_input noMargin">
                                <i class="icon IconPwd"></i>
                                <input type="text" v-model="tel" tabindex="3" name="tel" placeholder="tel" class="regi_login_input regi_login_input_left login-input-no input_text" @keyup.enter="addAddress">
                            </li>
                            <li class="regi_form_input noMargin">
                                <i class="icon IconPwd"></i>
                                <input type="text" v-model="postCode" tabindex="4" name="postCode" placeholder="postCode" class="regi_login_input regi_login_input_left login-input-no input_text" @keyup.enter="addAddress">
                            </li>
                        </ul>
                    </div>
                    <div class="login-wrap"><a href="javascript:;" class="btn-login" @click="addAddress">新增</a></div>
                </div>
            </div>
        </div>
        <div class="md-overlay" v-if="addModelFlag" @click="addModelFlag=false"></div>
    </div>
</template>
<style>
</style>
